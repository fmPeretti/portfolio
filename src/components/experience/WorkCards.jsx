  ...
  return (
    <>
      <WorkCard
        ...
        workDescription={
          <>
            As a developer for Stargazer, a marketing with influencers company with multiple clients, I was responsible for working on different portals for each client, where I refactored and developed new features.<br/>

            I got valuable knowledge about the business logic, use cases and processes of each client, allowing me to come up with new and innovative features for their portals. <br />

            Working closely with the CTO and my team, we organized sprints, discussed design, and reviewed progress to ensure that all features were implemented efficiently and effectively. <br />
            
            I also added support for new social media platforms, debugged and tested the portals, and maintained the codebase, addressing technical debt and fixing bugs as needed. <br />
            ...
            In addition to my development work, I did research on AI technologies and explored multiple AI services and APIs, including Text to Image, Text to Audio, Audio to Text, and Img to Video technologies, staying on the cutting edge of industry developments and bringing new ideas and approaches to the Stargazer team. <br />
